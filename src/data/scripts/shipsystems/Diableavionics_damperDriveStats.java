...
public class Diableavionics_damperDriveStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        if(!Global.getCombatEngine().isPaused()){
            ...
            if(tick.intervalElapsed()){
                ...
                if(ship!=null){
                    ship.addAfterimage(new Color(255, 60, 229,64), 0, 0, -ship.getVelocity().x, -ship.getVelocity().y, 0, 0, 0, effectLevel, false, false, false);
                }
            }
        }
    }
